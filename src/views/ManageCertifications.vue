                        ...
                        <div class="cert-details">
                            ...
                            <div class="cert-info">
                                ...
                                <div class="cert-row">
                                    ...
                                    <span class="cert-value cert-expiry-days" :class="getExpiryClass(cert.expiryDate)">
                                        {{ getDaysToExpiry(cert.expiryDate) }} days
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="cert-modal">
                        ...
                        <form @submit.prevent="addCertification" class="cert-form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" id="certExpiry" v-model="newCert.expiryDate" required class="form-input">
                            </div>
      ...
      certifications: [
        {
          ...
          image: 'https://via.placeholder.com/150x100/005792/ffffff?text=Safety+Cert'
        },
        {
          name: 'International Ship Security Certificate',
          expiryDate: '2025-08-30',
          image: 'https://via.placeholder.com/150x100/349940/ffffff?text=ISSC'
        },
        {
          name: 'Radio Safety Certificate',
          expiryDate: '2025-07-10',
          image: 'https://via.placeholder.com/150x100/dc3545/ffffff?text=Radio+Cert'
        },
        {
          name: 'Maritime Labour Certificate',
          expiryDate: '2026-03-22',
          image: 'https://via.placeholder.com/150x100/6f42c1/ffffff?text=MLC+Cert'
        }
      ],
      newCert: {
        name: '',
