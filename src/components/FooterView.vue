<template>
  ...
  <section class="cta" id="demo">
    <div class="container">
      ...
      <p>Schedule a personalized demo today and discover how OceanHelm can help your fleet operate more efficiently,
        reduce costs, and maintain regulatory compliance. Join maritime companies across Nigeria and West Africa that
        trust OceanHelm for their fleet management needs.</p>
      <a href="/contact?intent=demo" @click.prevent="contactDemo()" class="primary-button"
        aria-label="Request a personalized demo">Request Demo</a>
    </div>
  </section>
  <footer id="contact">
    <div class="container">
      <div class="footer-grid">
        <div class="footer-about">
          <h3>OceanHelm</h3>
          <p>Comprehensive maritime management software for modern fleets. Streamlining maintenance, requisition
            processing, inventory management, and cross-vessel communication.</p>
