            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav align-items-center">
                        <li class="nav-item">
                            <a class="nav-link fw-semibold px-3" href="/features">Our Offering</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fw-semibold px-3" href="/">Who We Are</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fw-semibold px-3" href="#testimonials">Testimonials</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fw-semibold px-3" href="/pricing">Pricing</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fw-semibold px-3" href="https://blog.oceanhelmtech.com">Blog</a>
                        </li>
